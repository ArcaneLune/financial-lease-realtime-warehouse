...
public class DwsLeaseExecutionBean implements Serializable {
    ...
    @JsonProperty(value = "execution_time", access = JsonProperty.Access.WRITE_ONLY)
    public String executionTime;
    public DwsLeaseExecutionBean() {}
}
