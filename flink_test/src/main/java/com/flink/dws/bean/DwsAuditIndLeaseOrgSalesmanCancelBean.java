...
/** 审批域-行业业务方向经办人粒度-审批取消窗口汇总（无 reply_amount） */
@JsonIgnoreProperties(ignoreUnknown = true)
public class DwsAuditIndLeaseOrgSalesmanCancelBean implements Serializable {
    ...
    @JsonProperty(value = "cancel_time", access = JsonProperty.Access.WRITE_ONLY)
    public String cancelTime;
    public DwsAuditIndLeaseOrgSalesmanCancelBean() {}
}
